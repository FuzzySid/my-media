                   ...
                   <h2 className="center">
                    ...
                    <div className="col s12 m7">
                        ...
                        <ul className="collection user-collection align-right">
                            ...
                            <i className="material-icons circle black">account_circle</i>
                            
                            <p>{user.name} <br/>
                               {user.email}
                            </p>
                            <a href="#!" className="secondary-content"><i className="material-icons">create</i></a>
                            </li>
                            <li className="collection-item avatar">
                            <i className="material-icons circle black">location_city</i>
